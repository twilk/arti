  ...
  return (
    <div className="space-y-12">
      ...
      <div className="grid gap-10 md:grid-cols-[minmax(0,1fr)_minmax(0,18rem)]">
        {/* Bylo tu przyklejenie rysunku do gory ekranu. Cofniete: pomiar pokazal,
            ze karta i najdalszy suwak dziela 690 pikseli przy oknie 812, wiec widac
            je razem bez zadnych sztuczek. Przyklejenie dokladalo zagniezdzone
            przewijanie na dotyku i nie rozwiazywalo niczego. */}
        <div>
          {skonczone && (
